...
public class MaleNPC extends NPC {
	...
	public MaleNPC(Level level, int id, float x, float y, float xt, float yt, String name, String levelName, Array<NPCDialogue> dialogues, String direction, boolean canMove) {
